...
?>
    ...
    if ($this->rights == 'write'):
?> <input 
		class="required" type="text" name="expected_lecture" value="<?php
...
?>
			<?php
        echo $this->lists['docs_checked'];
?>
		<?php
    else:
?>
			<?php
        echo ($this->applicant->docs_checked) ? JText::_('YES') : JText::_('NO');
?>
		<?php
    endif;
?>
	...
	<tr class="sectiontableentry1">
		<td width="15%" valign="top"><?php
    echo JText::_('MISSING_DOCS');
?>:</td>
		<td>
		<?php
    if ($this->rights == 'write'):
?>
			<textarea name="missing_docs" cols="50" rows="4"><?php
        echo ($this->applicant->missing_docs);
?></textarea>
		<?php
    else:
?>
...
?>
	...
	<tr class="sectiontableentry1">
		<td width="15%" valign="top"><?php
    echo JText::_('ACADEMIC_COMMENTS');
?>:</td>
		<td>
		<?php
    if ($this->rights == 'write'):
?>
			<textarea name="academic_comments" cols="50" rows="4"><?php
        echo ($this->applicant->academic_comments);
?></textarea>
		<?php
    else:
?>
...
?>
	...
	<tr class="sectiontableentry1">
		<td width="17%"><?php
    echo JText::_('APPLICANT_CONTACTED');
?>:</td>		
		<td>
		<?php
    if ($this->rights == 'write'):
?>
			<?php
        echo $this->lists['applicant_contacted'];
?>
		<?php
    else:
?>
			<?php
        echo ($this->applicant->applicant_contacted) ? JText::_('YES') : JText::_('NO');
?>
		<?php
    endif;
?>
	...
	<tr class="sectiontableentry1">
		<td><?php
    echo JText::_('APPLICANT_CONTACTED_DATE');
?>:</td>
		<td>
		<?php
    if ($this->rights == 'write'):
...
?>
			<input type="text" name="applicant_contacted_date" id="applicant_contacted_date"
				value="<?php
        echo $this->applicant->applicant_contacted_date;
?>" size="10"
				maxlength="10" /> <img class="calendar"
				src="./templates/system/images/calendar.png" alt="calendar"
...
?>
				<?php
        echo $this->lists['indian'];
?>
			<?php
    else:
?>
				<?php
        echo ($this->applicant->indian) ? JText::_('YES') : JText::_('NO');
?>
			<?php
    endif;
?>
	...
	<tr class="sectiontableentry1">
		<td width="15%" valign="top"><?php
    echo JText::_('INDIAN_INFO');
?>:</td>
		<td>
		<?php
    if ($this->rights == 'write'):
?>
			<textarea name="indian_info" cols="50" rows="4"><?php
        echo ($this->applicant->indian_info);
?></textarea>
		<?php
    else:
?>
...
?>:</td>
        ...
        if ($this->rights == 'write'):
            ...
            echo $this->applicant->committee_username;
?> <?php
        endif;
?></td>
	</tr>
